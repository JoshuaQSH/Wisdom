...
def give_model_label(labels_path="/home/shenghao/deepimportance_code_release/sh-demo/captum_demo/images/"):
...
def compute_attr(model, pred_label_idx, transformed_img, input):
    ...
    plt_fig, plt_axis = viz.visualize_image_attr(np.transpose(attributions_ig.squeeze().cpu().detach().numpy(), (1,2,0)),
                                ...
                                sign='positive',
                                outlier_perc=1)
    plt.savefig('images/swan_demo_1.png')
    ...
    plt_fig, plt_axis = viz.visualize_image_attr_multiple(np.transpose(attributions_ig_nt.squeeze().cpu().detach().numpy(), (1,2,0)),
                                        ...
                                        cmap=default_cmap,
                                        show_colorbar=True)
    plt.savefig('images/swan_demo_2.png')
    ...
    plt_fig, plt_axis = viz.visualize_image_attr_multiple(np.transpose(attributions_gs.squeeze().cpu().detach().numpy(), (1,2,0)),
                                        ...
                                        cmap=default_cmap,
                                        show_colorbar=True)
    plt.savefig('images/swan_demo_3.png')
    ...
    plt_fig, plt_axis = viz.visualize_image_attr_multiple(np.transpose(attributions_occ.squeeze().cpu().detach().numpy(), (1,2,0)),
                                        ...
                                        show_colorbar=True,
                                        outlier_perc=2)
    plt.savefig('images/swan_demo_4.png')
    ...
    plt_fig, plt_axis = viz.visualize_image_attr_multiple(np.transpose(attributions_occ.squeeze().cpu().detach().numpy(), (1,2,0)),
                                        ...
                                        show_colorbar=True,
                                        outlier_perc=2)
    plt.savefig('images/swan_demo_4-2.png')
...
def lrp_vgg(pred_label_idx, transformed_img, input):
    model = models.vgg16(weights=models.vgg.VGG16_Weights.IMAGENET1K_V1)
    model.eval()
    lrp = LRP(model)
    ...
    _ = viz.visualize_image_attr_multiple(np.transpose(attributions_lrp.squeeze().cpu().detach().numpy(), (1,2,0)),
                                        ...
                                        show_colorbar=True,
                                        outlier_perc=2)
    plt.savefig('images/swan_demo_5.png')
    ...
    _ = viz.visualize_image_attr_multiple(np.transpose(attributions_lrp.squeeze().cpu().detach().numpy(), (1,2,0)),
                                        ...
                                        show_colorbar=True,
                                        outlier_perc=2)
    plt.savefig('images/swan_demo_5-2.png')

if __name__ == "__main__":
    model, pred_label_idx, transformed_img, input = test_one()
    # compute_attr(model, pred_label_idx, transformed_img, input)
    lrp_vgg(pred_label_idx, transformed_img, input)